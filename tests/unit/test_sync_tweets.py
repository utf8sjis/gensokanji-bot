...
FILE_TWEETS = [
    TweetItem(id="main002", type="regular", group="main", text="テスト2", image_paths=["main002.png"]),
    TweetItem(id="main003", type="regular", group="main", text="テスト3-1", image_paths=["main003.png"]),
    TweetItem(
        id="main004", type="regular", group="main", text="テスト4", image_paths=["main004-1.png", "main004-2.png"]
    ),
    TweetItem(id="main005", type="regular", group="main", text="テスト5", image_paths=["main005.png"]),
]

DB_TWEETS = [
    TweetItem(id="main001", type="regular", group="main", text="テスト1", image_paths=["main001.png"]),
    TweetItem(id="main002", type="regular", group="main", text="テスト2", image_paths=["main002.png"]),
    TweetItem(id="main003", type="regular", group="main", text="テスト3", image_paths=["main003.png"]),
    TweetItem(id="main004", type="regular", group="main", text="テスト4", image_paths=["main004.png"]),
]


@pytest.fixture(autouse=True)
def mock_get_all_tweets_from_file():
    with patch("bot.sync_tweets.get_all_tweets_from_file", return_value=FILE_TWEETS) as mock:
        yield mock
